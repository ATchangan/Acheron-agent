...
export async function runTool(name: string, a: Record<string, unknown>, snapCfg?: SettingsData): Promise<string> {
  ...
  const curAg = window.__huangquan_agent
  if (curAg) {
