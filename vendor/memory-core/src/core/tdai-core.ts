 ...
 *
 * This is the single entry point that both OpenClaw and Agent/Gateway call
...
export class TdaiCore {
   ...
   * Maps to: OpenClaw `before_prompt_build` / Agent `prefetch()`.
   */
   ...
   * Maps to: OpenClaw `agent_end` / Agent `sync_turn()`.
   */
   ...
   *
   *   - **`on_session_end` (Agent) / `POST /session/end` (Gateway)**
