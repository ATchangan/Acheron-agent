...
function resolveDefaultDataDir(): string {
  ...
  // New canonical location: everything related to standalone/Agent-mode TDAI
  ...
  //
  // Note: this only governs the standalone/Agent fallback. Under the openclaw
  ...
  // (install_agent_memory_tencentdb.sh, Step 0) will migrate it on next run.
  try {
