        ...
        {tab==='general'&&<section className="settings-section">
          ...
          <div className="setting-row">
            ...
            <div style={{display:'flex',gap:8,alignItems:'center'}}>
              <input value={workDir} onChange={e=>setWorkDir(e.target.value)} style={{width:220,fontSize:11}}/>
              <button className="btn-small" onClick={async()=>{const d=await window.huangquan.computer.selectDir();if(d)setWorkDir(d)}}>选择</button>
            </div>
          </div>
        </section>}
