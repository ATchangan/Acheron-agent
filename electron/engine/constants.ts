// electron/engine/constants.ts — 独立内核常量(从渲染层 constants.ts 移植, 纯数据)
...
export const VISION_MODEL_HINTS = ['gpt-4o', 'gpt-4-turbo', 'gpt-4.1', 'claude-3', 'claude-3.5', 'claude-3.7', 'gemini', 'vision', 'vl', 'vlm', 'qwen-vl', 'qwen2-vl', 'qwen2.5-vl', 'qwen3-vl', 'glm-4v', 'glm-4.5v', 'glm-4.6v', 'glm-4.1v', 'minimax-vl', 'deepseek-vl', 'internvl', 'internvl2', 'llava', 'yi-vision', 'step-1v', 'moonshot-v1-8k-vision', 'minicpm-v', 'pixtral', 'phi-vision', 'llama-3.2-vision', 'moondream', 'hunyuan-vision', 'doubao-vision', 'ocr']
