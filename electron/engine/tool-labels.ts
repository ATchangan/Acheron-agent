...
export function toolLabel(tc: EngineToolCall): string {
  const labels: Record<string, string> = {
    ...
    clipboard_write: '写入剪贴板', process_list: '列出进程', kill_process: '结束进程',
    session_search: '搜索会话', memory_search: '记忆检索', conversation_search: '对话检索', skill_search: '技能检索', codebox: '运行代码',
