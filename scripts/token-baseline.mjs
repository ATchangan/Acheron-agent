...
// v0.3.2 T3: 对比维度扩展 —— 0.3.0(基线) vs 0.3.2(本版), 同任务集逐项对照
...
> v0.3.2 对比: 同一任务集分别跑 0.3.0 与 0.3.2, 记录两侧 token/请求数/完成度

| 任务 | 类型 | 描述 | 0.3.0 token | 0.3.2 token | 降幅% | 请求数(0.3.0→0.3.2) | 工具次数(0.3.0→0.3.2) | 完成度(0.3.0) | 完成度(0.3.2) | 输出字数(0.3.0→0.3.2) |
|---|---|---|---|---|---|---|---|---|---|
${rows}
...
- 0.3.2 总降幅目标 ≥50%（系列叠加）; 完成度 100%; 失败任务二分定位到具体优化项（0.3.2 T3）
`
